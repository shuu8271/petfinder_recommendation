...
def download_data(offset=0):
    if offset == 0:
        init_parameters = {'animal':'dog', 'format':'json', 'output':'full',\
                            'location':['New York, NY', 'Manhattan, NY',\
                                        'Astoria, NY', 'Brooklyn, NY', 'Jersey City, NJ'],\
                            'count':1000}
        ...
        parameters = {'animal':'dog', 'format':'json', 'output':'full', 'offset':str(offset),\
                            'location':['New York, NY', 'Manhattan, NY', 'Astoria, NY',\
...
if __name__ == '__main__':
    ...
    for num in [0, 1000, 1200, 1400, 1600, 1800, 2000]:
        ...
        save_cols = ['pet_id', 'name', 'age', 'breeds', 'description', 'media', 'sex', \
                    'size', 'status']
